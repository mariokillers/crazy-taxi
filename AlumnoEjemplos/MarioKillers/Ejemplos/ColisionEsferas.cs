...
namespace AlumnoEjemplos.MarioKillers.Ejemplos
{
    public class ColisionBoundingSpheres : TgcExample
    {
        ...
        public override void init()
        {
            ...
            box = new RigidBody(30.0f, TgcBox.fromSize(new Vector3(13, 5, 5), Color.Turquoise).toMesh(""));
            cube = new RigidBody(15.0f, TgcBox.fromSize(new Vector3(9, 9, 9), Color.HotPink).toMesh(""));
            cube2 = new RigidBody(10.0f, TgcBox.fromSize(new Vector3(5, 5, 5), Color.Blue).toMesh(""));
